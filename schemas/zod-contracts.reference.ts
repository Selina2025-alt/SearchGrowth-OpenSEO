...
export const bridgeReceiptSchema = z.object({
  ...
  status: z.enum([
    "DRAFT_CREATED","DRAFT_VERIFIED","ACCEPTED_REMOTE_TASK","PUBLISH_SUBMITTED",
    "PUBLIC_VERIFIED","AUTH_REQUIRED","REMOTE_STATE_UNKNOWN","REJECTED",
    "EXECUTION_FAILED","VERIFY_FAILED"
  ]),
